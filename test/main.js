...
describe('gulp-hide-email', function() {
    ...
    describe('for simualted buffered input', function() {
        ...
        it('should obfuscate <a href="mailto:xxx@xxx.xxx">...</a> on a simulated buffer', function(done) {
        ...
        it('should trigger events on a buffer so other methods in the pipe don\'t hang up!', function(done) {
            var stream = obfuscateEmail(options);
    ...
    describe('for streamed input', function() {
        ...
        it('should obfuscate <a href="mailto:xxx@xxx.xxx">...</a> on a simulated stream', function(done) {
            var stream = obfuscateEmail(options);
